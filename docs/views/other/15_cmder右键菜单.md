...
title: cmder右键菜单
category: other
date: 2021-17-10 09:29:20
---
1. 下载 [传送门](https://cmder.net/)
2. cmder是**免安装**的，所以直接解压到自己的目标文件夹即可。
3. 进入cmder安装目录。
   ```bash
   # 我的是在D盘: D:\cmder
   D:\>cd cmder
...
4. 执行命令。
   ...
   ```
   > 以上命令执行完毕，鼠标右键菜单就有cmder了
   
5. 配置文件。
   > 个人常用的配置文件，保存到`.xml`文件中，然后直接导入即可。
   ```xml
   <?xml version="1.0" encoding="utf-8"?>
    <key name="Software">
    	<key name="ConEmu">
    		<key name=".Vanilla" modified="2021-10-17 10:22:25" build="210304">
    			...
    			<value name="Multi.CloseConfirmFlags" type="hex" data="05"/>
    			...
    			<value name="FontSize" type="ulong" data="18"/>
    			...
    			<value name="bgImageDarker" type="hex" data="CC"/>
    			...
    			<value name="ConWnd X" type="long" data="-1"/>
    			<value name="ConWnd Y" type="long" data="110"/>
    			<value name="LastMonitor" type="string" data="0,0,1920,1020"/>
    			<value name="ConWnd Width" type="dword" data="00000074"/>
    			<value name="ConWnd Height" type="dword" data="0000000b"/>
    			...
    			<value name="OneTabPerGroup" type="hex" data="01"/>
    			...
    			<value name="TabsOnTaskBar" type="hex" data="00"/>
    			...
    			<key name="HotKeys" modified="2021-10-17 10:22:25" build="210304">
    			...
    			<key name="Tasks" modified="2021-10-17 10:22:25" build="210304">
    				<value name="Count" type="long" data="9"/>
    				<key name="Task1" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task2" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task3" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task4" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task5" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task6" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task7" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task8" modified="2021-10-17 10:22:25" build="210304">
    				...
    				<key name="Task9" modified="2021-10-17 10:22:25" build="210304">
    			...
    			<key name="Apps" modified="2021-10-17 10:22:25" build="210304">
    				<value name="Count" type="long" data="0"/>
    			</key>
    			<key name="Colors" modified="2021-10-17 10:22:25" build="210304">
    				<value name="Count" type="long" data="1"/>
    				<key name="Palette1" modified="2021-10-17 10:22:25" build="210304">
